...
im2 = rgb2gray(imread('../images/lena.jpg'))
im2 = gaussian(im2, 5)
...
epsilon = 10**-6
freq2 = fp.fft2(im_blur2)
freq_kernel2 = 1 / (epsilon + freq_kernel2) #avoid division by zero
convolved2 = freq*freq_kernel2

im_restored2 = fp.ifft2(convolved).real
...
pylab.subplot(326), pylab.imshow(im_restored2, cmap='gray'), pylab.title('Restored Image 2'), pylab.axis('off')
