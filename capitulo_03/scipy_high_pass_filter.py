...
from scipy.fftpack import fft2, ifftshift, fftn, ifftn
...
im1 = np.clip(fp.ifft2(ifftshift(freq2)).real, 0, 255) #clip pixel values after IFFT


pylab.figure(figsize=(10, 5))
pylab.subplot(2, 2, 1), pylab.imshow(im, cmap=pylab.gray()), pylab.axis('off'), pylab.title('Rhino Original Image')
